      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base text-[var(--brand-dark)]">Trayectoria y Capacidad</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base text-[var(--brand-dark)]">Certificaciones y Cumplimiento</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base text-[var(--brand-dark)]">Condiciones Comerciales</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base text-[var(--brand-dark)]">Presencia Regional y Sostenibilidad</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
