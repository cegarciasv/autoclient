      ...
      <div className="space-y-6">
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base text-[var(--brand-dark)]">Balance General</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base text-[var(--brand-dark)]">Flujo de Ingresos y Egresos</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base text-[var(--brand-dark)]">Operaciones Internacionales</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {tieneOpsInternacionales && (
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full border border-gray-200 rounded-md px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[var(--brand-primary)] focus:border-transparent"
