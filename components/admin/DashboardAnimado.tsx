            ...
            <CardContent className="space-y-3">
              <Link
                ...
                className={buttonVariants({
                  className: "w-full bg-gradient-to-r from-[#1E3A8A] to-[#2563EB] hover:from-[#1D4ED8] hover:to-[#2563EB] text-white font-semibold gap-2 justify-center",
                })}
              >
                    ...
                    >
                      ...
                      >
                        <div className={`flex-shrink-0 h-8 w-8 rounded-full flex items-center justify-center text-xs font-bold text-white ${
                          esCliente ? "bg-gradient-to-br from-[#2563EB] to-[#1E3A8A]" : "bg-gradient-to-br from-purple-500 to-purple-700"
                        }`}>
                          {inicial}
                        </div>
