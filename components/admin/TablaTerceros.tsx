...
const ESTADO_MAP = {
  ...
  EN_PROCESO: {
    label: "En proceso",
    cls: "bg-[#2563EB]/10 text-[#1E3A8A] border-[#2563EB]/20",
    dot: "bg-[#2563EB]",
    pulse: true,
  },
  COMPLETADO: {
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input
            ...
            className="pl-9 h-10 border-slate-200 focus:border-[#2563EB] focus:ring-[#2563EB]/20 transition-colors"
            value={busqueda}
        ...
        <Link
          ...
          className={buttonVariants({
            className:
              "bg-[#2563EB] hover:bg-[#1D4ED8] text-white shadow-sm shadow-blue-900/10 transition-all",
          })}
        >
            ...
            {filtrados.length === 0 ? (
              ...
              filtrados.map((t) => {
                ...
                return (
                  <TableRow
                    key={t.id}
                    className="group hover:bg-[#2563EB]/5 transition-colors duration-150 border-l-2 border-transparent hover:border-[#2563EB]"
                  >
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <Button
                          ...
                          className="h-8 w-8 p-0 text-slate-500 hover:text-[#2563EB] hover:bg-blue-50 transition-colors"
                        >
                          <Send
                        ...
                        <Link
                          ...
                          className={buttonVariants({
                            ...
                            variant: "ghost",
                            className:
                              "h-8 w-8 p-0 text-slate-500 hover:text-[#2563EB] hover:bg-blue-50 transition-colors",
                          })}
                        >
