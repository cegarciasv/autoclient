    ...
    try {
      ...
      function bandaHeader(esPortada = false) {
        ...
        doc.fillColor("white")
          ...
          .text("TRANSPORTE SEBASTIÁN", ML, esPortada ? 22 : 14, { width: CW });
      ...
      doc.font("Helvetica").fontSize(7).fillColor("#78350f")
        .text(
          "Este documento contiene información confidencial de uso exclusivo de Transporte Sebastián. " +
      ...
      doc.fillColor("#0c4a6e").font("Helvetica").fontSize(8.5)
        .text(
          ...
          "se compromete a notificar a Transporte Sebastián cualquier modificación relevante en los datos aquí " +
          "consignados dentro de los treinta (30) días siguientes a su ocurrencia.\n\n" +
          "Autoriza expresamente a Transporte Sebastián a verificar la información suministrada y a utilizarla " +
      ...
      doc.fillColor(GRIS_L).font("Helvetica").fontSize(7)
        .text(
          `Documento generado electrónicamente el ${new Date().toLocaleString("es-SV")} | Transporte Sebastián — Sistema de Vinculación de Terceros`,
